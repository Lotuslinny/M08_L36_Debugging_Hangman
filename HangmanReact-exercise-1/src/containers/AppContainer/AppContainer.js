...
//Debugging:
//1. Read through code outloud!
//2.TRAFFIC Track the problem: the return. |In gameOver.js the return is correct.
//Console.log the function wordGuessed. Consol.log and alerts in the code downwards..
const wordList = [
  "vis",
  "toeter",
  "developer",
