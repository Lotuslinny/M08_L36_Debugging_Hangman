...
// Regel 46 aan code toegevoegd. Een condition toegevoegd:if (newGuessedLetters !== this.state.currentChosenLetter)
...
class AppContainer extends React.Component {
  ...
  guessLetterHandler = event => {
    ...
    if (newGuessedLetters !== this.state.currentChosenLetter) {
